...
class VideoHelperTest extends TestCase
{
    ...
    public function testEmbed()
    {
        ...
        $expected = '<iframe width="624" height="369" src="//www.youtube.com/embed/heNGFmEQVq0?hd=1&amp;rel=0&amp;autoplay=0&amp;showinfo=0" frameborder="0" allowfullscreen="allowfullscreen"></iframe>';
